...
void AEMaterialBindLightmapEXT(AEMaterial* material,GLuint lightmap){
...
void AEMaterialTextureSet(AEMaterial* material,const char* name,GLuint texture){
	material->texUnitCount++;
	material->textures=realloc(material->textures,material->texUnitCount*sizeof(GLuint));
	material->textureNames=realloc(material->textureNames,material->texUnitCount*sizeof(char*));
	material->textureNames[material->texUnitCount-1]=AECloneString(name);
