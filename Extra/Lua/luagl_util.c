...
DEFINE_GET_ARRAY_FUNC(luagl_get_arrayb, GLubyte, lua_toboolean)
DEFINE_GET_ARRAY_FUNC(luagl_get_arrayd, GLdouble, lua_tonumber)
DEFINE_GET_ARRAY_FUNC(luagl_get_arrayf, GLfloat, lua_tonumber)
DEFINE_GET_ARRAY_FUNC(luagl_get_arrayi, GLint, lua_tointeger)
DEFINE_GET_ARRAY_FUNC(luagl_get_arrayui, GLuint, lua_tointeger)
DEFINE_GET_ARRAY_FUNC(luagl_get_arrayuc, GLubyte, lua_tointeger)

DEFINE_GET_ARRAY_POINTER_FUNC(luagl_get_arrayb_pointer, GLubyte, lua_toboolean)
DEFINE_GET_ARRAY_POINTER_FUNC(luagl_get_arrayd_pointer, GLdouble, lua_tonumber)

DEFINE_GET_ARRAY2_FUNC(luagl_get_array2uc, GLubyte, lua_tointeger)
DEFINE_GET_ARRAY2_FUNC(luagl_get_array2d, GLdouble, lua_tonumber)
DEFINE_GET_ARRAY2_FUNC(luagl_get_array2f, GLfloat, lua_tonumber)

DEFINE_GET_ARRAY2_POINTER_FUNC(luagl_get_array2d_pointer, GLdouble, lua_tonumber)
...
DEFINE_PUSH_ARRAY_FUNC(luagl_push_arrayb, GLubyte, lua_pushboolean)
DEFINE_PUSH_ARRAY_FUNC(luagl_push_arrayi, GLint, lua_pushinteger)
DEFINE_PUSH_ARRAY_FUNC(luagl_push_arrayui, GLuint, lua_pushinteger)
DEFINE_PUSH_ARRAY_FUNC(luagl_push_arrayf, GLfloat, lua_pushnumber)
DEFINE_PUSH_ARRAY_FUNC(luagl_push_arrayd, GLdouble, lua_pushnumber)
DEFINE_PUSH_ARRAY_FUNC(luagl_push_arrayuc, GLubyte, lua_pushinteger)
